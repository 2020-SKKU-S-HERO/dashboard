...
const gasCensorSwitchery = new Switchery(gasCensorToggleBtn, { size: 'small' });
const flowCensorSwitchery = new Switchery(flowCensorToggleBtn, { size: 'small' });
const tempCensorSwitchery = new Switchery(tempCensorToggleBtn, { size: 'small' });